...
| 3 | Recipe engine regression safety net | Protect the tunable recipe knobs and the NFR timing budget against silent drift | #5 | unit (fixtures) + timing smoke | change opened | context/changes/testing-recipe-engine-regression-safety-net/ |
